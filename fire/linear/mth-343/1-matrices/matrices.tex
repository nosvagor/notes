...
\begin{itemize}
  ...
  \newpage
    \minor{\item[19.] A fourth way to multiply matrices is columns of \tbm{A} times rows
      ...
      \right)
      \end{align*}
      Useful, as the left matrix can be thought of as the \aset{weights that scale}
      the elements of the columns of the right matrix.
  ...
  \item []
    ...
    \begin{enumerate}\setcounter{enumi}{24}\color{foreground-2}
      ...
      \item \tbm{A} and \tbm{B} are symmetric across the diagonal (because 4 =
        4). Find their triple factorizations \tbm{LDU} and say how \tbm{U} is
